...
function activate(context) {
    ...
    let get_firmware = vscode.commands.registerCommand('extension.update_firmware', function () {
        ...
        ter.show(); 
        ter.sendText("cd " + toolsPath());
        ter.sendText("curl https://tech.microbit.org/docs/software/assets/DAPLink-factory-release/0249_kl26z_microbit_0x8000.hex -o ./hardware/microbit_update_V1.hex");
    });
